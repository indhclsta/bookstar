...
<style>
  ...
  .bg-soft-success { background-color: rgba(6, 214, 160, 0.1) !important; }
  .bg-soft-info { background-color: rgba(17, 138, 178, 0.1) !important; }
  .bg-soft-warning { background-color: rgba(255, 209, 102, 0.1) !important; }
  .bg-soft-danger { background-color: rgba(239, 71, 111, 0.1) !important; }
  .bg-soft-purple { background-color: rgba(111, 66, 193, 0.1) !important; }
